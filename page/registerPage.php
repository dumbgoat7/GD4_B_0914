  ...
  <body>
    <nav class="navbar navbar-dark bg-dark fixed-top">
      <div class="container">
        ...
        <a class="navbar-brand fw-bold" href="/gd4_b_0914">PHP - Rakai</a>
      </div>
    </nav>
    <div class="bg bg-light text-dark">
      <div
        class="container min-vh-100 mt-5 d-flex align-items-center justify-content-center">
        <div
          class="card text-white bg-dark ma-5 shadow "
